...
public class PictureUtils {  
    ...
    public BufferedImage modifyImagetogeter(BufferedImage b, BufferedImage d) {  
        ...
        try {  
            ...
            g = d.createGraphics();  
            g.drawImage(b, 250, 1753, w, h, null);  
            g.dispose();  
        } catch (Exception e) {  
            System.out.println(e.getMessage());  
        }  
    ...
    public static void main(String[] args) {  
        ...
        BufferedImage d = tt.loadImageLocal("D:\\testtxt\\share.jpg");  
        BufferedImage b = tt.loadImageLocal("D:\\testtxt\\cca8baafb72a45218b065028007b9374.png");    
        //往图片上写文件    
        //tt.writeImageLocal("E:\\ploanshare\\2\\22.jpg", tt.modifyImage(d, "000000", 90, 90));  
  
        tt.writeImageLocal("D:\\testtxt\\cc.jpg", tt.modifyImagetogeter(b, d));    
        //将多张图片合在一起    
