...
public class EmailController extends BaseController {
	...
	public BackResult<String> sendMail(HttpServletRequest request, HttpServletResponse response,
			String userName,String emailRecive) {
		...
		BackResult<String> creUserDomain = emailService.sendMail(userName,emailRecive,code+"",null);
		...
		redisClinet.set("client:email_code_" + creUserDomain.getResultObj(),code+"",60 * 60 * 1000);	
